          ...
          <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
            ...
            <div class="lg:mx-auto text-left ">
              ...
              <ul class="text-sm  transition-all duration-500">
                ...
                <li class="mb-6">
                  <Link to="/about" class=" text-gray-600 hover:text-gray-900">
                    About Us
                  </Link>
                </li>
                <li class="mb-6">
            ...
            <div class="lg:mx-auto text-left ">
              <h4 class="text-lg text-gray-900 font-medium mb-7">I want to</h4>
              <ul class="text-sm  transition-all duration-500">
                <li class="mb-6">
                  <Link
                    to="javascript:;"
            ...
            <div class="lg:mx-auto text-left">
              <h4 class="text-lg text-gray-900 font-medium mb-7">Support Us</h4>
              <ul class="text-sm  transition-all duration-500">
                <li class="mb-6">
                  <Link
                    to="javascript:;"
          ...
          <div class="py-7 border-t border-gray-200">
            <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
              <span class="text-sm text-gray-500 ">
                ©<Link to="https://pagedone.io/">pagedone</Link> 2024, All
                rights reserved.
              </span>
